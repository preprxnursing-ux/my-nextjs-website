...
New-Item -ItemType Directory -Force -Path "app\checkout" | Out-Null
[System.IO.File]::WriteAllText("$PWD\app\checkout\page.tsx", $content, [System.Text.UTF8Encoding]::new($false))
Write-Host "Done! Lines: $((Get-Content app\checkout\page.tsx).Count)"
