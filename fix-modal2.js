...
// Find and replace the rationale + buttons section
const old1 = `padding:"16px 20px", borderRadius:12, background:ans===q.answer?"#dcfce7":"#fee2e2", border:"1.5px solid "+(ans===q.answer?"#16a34a":"#dc2626"), fontSize:15, color:ans===q.answer?"#15803d":"#dc2626", lineHeight:1.8, marginBottom:16, fontFamily:"Georgia, serif" }}>
...
const new1 = `position:"fixed", inset:0, background:"rgba(0,0,0,0.55)", zIndex:9999, display:"flex", alignItems:"center", justifyContent:"center", padding:"20px" }}>
                      <div style={{ background:"white", borderRadius:16, padding:"32px", maxWidth:560, width:"100%", boxShadow:"0 24px 60px rgba(0,0,0,0.3)" }}>
...
console.log('Done:', c.includes('inset:0') ? 'modal added!' : 'no match');