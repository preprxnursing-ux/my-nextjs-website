...
function ContactDropdown({ pathname }: { pathname: string }) {
  ...
  const people = [
    { name: "Melissa", role: "Student Success Lead", email: "preprxnursing@gmail.com", color: "#0ea5e9", initials: "M", avatar: "/james2.jpg", topics: "Platform . Courses . Account", response: "Within 4 hours", href: "/team/melissa" },
    { name: "James", role: "Founder & Educator", email: "prenclexreview@gmail.com", color: "#8b5cf6", initials: "J", avatar: "/melissa2.jpg", topics: "Partnerships . Media . Strategy", response: "Within 24 hours", href: "/team/james" },
  ];
