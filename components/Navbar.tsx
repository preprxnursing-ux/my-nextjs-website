...
function NursingTVDropdown({ pathname }: { pathname: string }) {
  ...
  return (
    <div style={{ position: "relative" }} onMouseEnter={handleEnter} onMouseLeave={handleLeave}>
      ...
      {open && (
        <div className="nav-dropdown" style={{ position: "absolute", left: "-160px", top: "100%", zIndex: 1001, paddingTop: "10px", width: "560px" }}>
          <div style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,.08)", borderRadius: "20px", boxShadow: "0 32px 80px rgba(0,0,0,.18)", overflow: "hidden" }}>
            <div style={{ padding: "13px 18px", borderBottom: "1px solid rgba(0,0,0,.06)", background: "linear-gradient(135deg,rgba(239,68,68,.04),rgba(14,165,233,.03))", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ padding: "12px", background: "#ffffff", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px" }}>
              {groups[activeGroup].channels.map(c => (
                <Link key={c.title} href="/nursing-tv"
                  ...
                  <div style={{ width: "32px", height: "32px", borderRadius: "9px", background: `${c.color}12`, border: `1px solid ${c.color}20`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div style={{ padding: "11px 16px", borderTop: "1px solid rgba(0,0,0,.06)", background: "#f8f9fb", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
