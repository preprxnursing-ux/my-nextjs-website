...
function ContactDropdown({ pathname }: { pathname: string }) {
  ...
  const people = [
    { name: "Melissa Ainsley", role: "Student Success Lead", email: "preprxnursing@gmail.com", color: "#0ea5e9", initials: "M", avatar: "/melissa2.jpg", topics: "Platform . Courses . Account", response: "Within 4 hours", href: "/team/melissa" },
