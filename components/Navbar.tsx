...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="mob-hide-on-mobile" style={{ position: "sticky", top: 0, zIndex: 1000, background: "#ffffff", borderTop: "3px solid #0ea5e9", borderBottom: "3px solid #0ea5e9", backdropFilter: "blur(20px)", boxShadow: "0 2px 16px rgba(0,0,0,0.08)" }}>
