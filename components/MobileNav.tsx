          ...
          {user && (<>
            <div className="mob-hero-user">
              <div style={{ display: "flex", alignItems: "center", gap: "10px", padding: "8px 12px", borderRadius: "12px", background: "linear-gradient(135deg,#0d1f35,#0f2540)", border: "1px solid rgba(14,165,233,0.2)" }}>
                ...
                <Link href="/dashboard" style={{ display: "flex", alignItems: "center", padding: "6px 12px", borderRadius: "20px", background: "rgba(14,165,233,0.15)", border: "1px solid rgba(14,165,233,0.3)", fontSize: "11px", fontWeight: 700, color: "#38bdf8", textDecoration: "none", flexShrink: 0 }}>Dashboard</Link>
              </div>
            </div>
            <div className="mob-section">
