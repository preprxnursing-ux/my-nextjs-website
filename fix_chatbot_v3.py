...
export default function ChatbotWidget({ autoOpen = false }: { autoOpen?: boolean }) {
  ...
  const suggestions = [
    ...
    "Generate a cardiac practice question"
  ];
    ...
    <>
      ...
      {open && (
        <div style={{
          ...
          width: size.width, height: size.height, borderRadius: 16,
          ...
          <div
            ...
            style={{
              ...
              background: "linear-gradient(to bottom, rgba(0,112,243,0.4), transparent)",
          ...
          <div
            ...
            style={{
              ...
              cursor: "nw-resize", zIndex: 10,
              background: "linear-gradient(to right, rgba(0,112,243,0.4), transparent)"
            }}
            title="Drag to resize"
          />
          ...
          <div style={{
            ...
            {messages.map((m, i) => (
              <div key={i} style={{
                ...
                maxWidth: "82%", fontSize: 14, whiteSpace: "pre-wrap", lineHeight: 1.5
              }}>
                {m.content}
              </div>
            ))}
