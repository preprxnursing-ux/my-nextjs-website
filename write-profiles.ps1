        ...
        <div className="fade-up" style={{ display: "grid", gridTemplateColumns: "340px 1fr", gap: "48px", alignItems: "start", marginBottom: "40px" }}>
          <div>
            <div style={{ position: "relative", borderRadius: "24px", overflow: "hidden", aspectRatio: "4/5", border: "1px solid rgba(14,165,233,.2)", boxShadow: "0 32px 80px rgba(0,0,0,.4)" }}>
              <Image src="/melissa.jpg" alt="Melissa" fill style={{ objectFit: "cover" }} />
          ...
          <div style={{ paddingTop: "8px" }}>
            ...
            <div style={{ padding: "24px 28px", background: "rgba(14,165,233,.06)", border: "1px solid rgba(14,165,233,.15)", borderRadius: "16px" }}>
              ...
              <p style={{ fontSize: "12px", color: "#0ea5e9", fontWeight: 700, marginTop: "14px", margin: "14px 0 0" }}>-- Melissa Ainsley, Student Success Lead</p>
            </div>
          </div>
        </div>
...
New-Item -ItemType Directory -Force -Path "app\team\melissa" | Out-Null
New-Item -ItemType Directory -Force -Path "app\team\james" | Out-Null
[System.IO.File]::WriteAllText("$PWD\app\team\melissa\page.tsx", $melissa, [System.Text.UTF8Encoding]::new($false))
[System.IO.File]::WriteAllText("$PWD\app\team\james\page.tsx", $james, [System.Text.UTF8Encoding]::new($false))
Write-Host "Done! Melissa: $((Get-Content app\team\melissa\page.tsx).Count) lines, James: $((Get-Content app\team\james\page.tsx).Count) lines"
