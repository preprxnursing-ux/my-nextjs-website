...
const plans = [
  ...
  },
  {
    ...
    price: "$99",
    period: "per month",
    description: "For nursing schools and tutors managing multiple students.",
    color: "border-slate-200",
    badge: null,
    cta: "Contact us",
    ctaHref: "/contact",
    ...
    <main className="min-h-screen bg-[#f1f5f9]">
      ...
      <div className="bg-black text-white px-4 py-20 text-center">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          Start free. Upgrade when you are ready. Cancel any time.
      ...
      <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`relative rounded-2xl border-2 bg-white p-8 shadow-sm ${plan.color} ${
                plan.badge ? "shadow-cyan-100 shadow-lg" : ""
              }`}
            >
              {/* BADGE */}
              {plan.badge && (
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              },
              {
                ...
                a: "The Free plan gives you full access to 30 questions and all exam modes so you can experience the platform before upgrading.",
              },
              {
                q: "What payment methods do you accept?",
                a: "We accept all major credit and debit cards via Stripe. Your payment information is never stored on our servers.",
              },
              {
                q: "What is your refund policy?",
                a: "If you are not satisfied within 7 days of upgrading we will issue a full refund, no questions asked.",
              },
              {
                q: "Does Premium include FNP and CCRN questions?",
                a: "Yes. Premium subscribers get access to all current and future question sets including FNP, CCRN, and NCLEX-PN.",
              },
              {
                q: "How is the Educator plan different?",
                a: "The Educator plan adds student management tools, bulk enrollment, progress tracking across accounts, and a dedicated support manager.",
              },
            ].map((item, i) => (
        ...
        <div className="mt-16 bg-black rounded-2xl p-10 text-center text-white">
          ...
          <p className="text-slate-400 mb-6">
            Join thousands of nursing students who trust Pre-NCLEX Review.
          </p>
