          ...
          <div className="w-full max-w-[420px] relative z-10 py-4">
            ...
            {step === "details" && (
              <>
                ...
                <h1 className="font-display text-white mb-1" style={{ fontSize: "clamp(1.6rem,3vw,2.1rem)", fontWeight: 700, lineHeight: 1.2 }}>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                      <button onClick={handleSuggest} title="Suggest strong password"
                        ...
                        style={{ color: "#34d399", fontSize: "0.62rem", letterSpacing: "0.05em" }}>
                        SUGGEST
                      </button>
                ...
                {showSuggested && (
                  <div className="mb-4 p-4 rounded-xl"
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <code className="text-sm font-mono" style={{ color: "#34d399", wordBreak: "break-all" }}>
                        {suggested}
                      </code>
            ...
            {step === "verify" && (
              <div className="text-center">
                ...
                <h2 className="font-display text-white mb-3" style={{ fontSize: "1.8rem", fontWeight: 700 }}>
                  Verify your email
                </h2>
                <p className="text-sm mb-6" style={{ color: "#64748b", fontWeight: 300, lineHeight: 1.75 }}>
                ...
                <div className="p-5 rounded-2xl mb-6 text-left space-y-3"
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <p className="text-xs" style={{ color: "#64748b", fontWeight: 300, lineHeight: 1.6 }}>{tip}</p>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex flex-col gap-3">
                  <Link href="/auth/login"
                    className="w-full py-3.5 rounded-xl text-sm font-medium text-center transition-all duration-200"
