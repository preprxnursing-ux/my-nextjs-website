          ...
          <div className="w-full max-w-[400px] relative z-10">
            ...
            {step === "forgot" && (
              <>
                ...
                <div className="mb-5">
                  <label className="block text-xs font-medium mb-1.5" style={{ color: "#64748b", letterSpacing: "0.05em" }}>Your email address</label>
            ...
            {step === "forgot-sent" && (
              <div className="text-center">
                ...
                <p className="text-sm mb-6" style={{ color: "#64748b", fontWeight: 300, lineHeight: 1.7 }}>
                  We sent a reset link to<br /><span style={{ color: "#e2e8f0" }}>{forgotEmail}</span>.<br />
                ...
                <div className="p-4 rounded-xl mb-6"
                  ...
                  <p className="text-xs" style={{ color: "#475569" }}>
                    ...
                    <button onClick={() => setStep("forgot")} className="hover:underline" style={{ color: "#34d399" }}>try again</button>.
                  </p>
                </div>
