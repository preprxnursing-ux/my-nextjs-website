...
export default function AITutorPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0f172a", color: "white", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ display: "flex", gap: 8, padding: "20px 20px 0", maxWidth: 900, margin: "0 auto" }}>
        <button onClick={() => setActiveTab("chat")} style={{ padding: "8px 22px", borderRadius: 20, border: "none", cursor: "pointer", fontWeight: 700, fontSize: 13, background: activeTab === "chat" ? "#0ea5e9" : "#1e293b", color: "white" }}>
          AI Tutor Chat
        </button>
        <button onClick={() => setActiveTab("anatomy")} style={{ padding: "8px 22px", borderRadius: 20, border: "none", cursor: "pointer", fontWeight: 700, fontSize: 13, background: activeTab === "anatomy" ? "#0ea5e9" : "#1e293b", color: "white" }}>
          Anatomy Visualizer
        </button>
      </div>

      {activeTab === "anatomy" && <AnatomyVisualizer />}
