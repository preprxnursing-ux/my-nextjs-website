            ...
            <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", minHeight: "220px" }}>
              ...
              <div style={{ padding: "22px", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#ffffff", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <p style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a", margin: "0 0 4px", fontFamily: "'Cormorant Garamond',serif", letterSpacing: ".01em" }}>{channel.title}</p>
                  <p style={{ fontSize: "11px", fontWeight: 600, color: channel.color, margin: "0 0 12px", letterSpacing: ".04em", textTransform: "uppercase" }}>{channel.tag}</p>
                  <p style={{ fontSize: "12px", color: "#475569", lineHeight: 1.75, margin: "0 0 16px", fontWeight: 500 }}>{channel.desc}</p>
...
if result == content:
    ...
    with open(r'components\Navbar.tsx', 'w', encoding='utf-8', newline='\n') as f:
        f.write(result)
    print("SUCCESS: NursingTVDropdown replaced with premium two-column design.")